...
- Squash merged `codex/web-api-job-runtime` into `main@6b8ba6f`; Development Plan
  2.0 progress is 3/5.
- Started `codex/interactive-demo-ui` from `main@b46d6f8`; implemented generated
  API types, Initial/Update/History surfaces, real SSE progress and result debug
  views.
- Live browser smoke confirmed Backend connectivity and identified an initial
  running-state regression, which is now covered by a component test.
