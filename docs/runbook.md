...
| `ANALYZE_AGENT_DATABASE_PATH` | `data/analyze-agent.sqlite3` | SQLite database |
...
make test
make lint
GOOGLE_API_KEY=test-placeholder make env-check
GOOGLE_API_KEY=test-placeholder make smoke-test
git diff --check
```
